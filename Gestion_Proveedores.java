...
public class Gestion_Proveedores extends javax.swing.JFrame {
    ...
    public Gestion_Proveedores() {
        ...
        try{
            prov = GuardarDatos.readFileTextProveedor();
        
        lista = new Object[prov.size()][4];
        for(int i=0;i<prov.size();i++){
            lista[i][0]=prov.get(i).getNombre();
            lista[i][1]=prov.get(i).getCI();
            lista[i][2]=prov.get(i).getDireccion();
            lista[i][3]=prov.get(i).getNumero();
        }
    ...
    private void btGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGuardarActionPerformed
        ...
        for(int i=0;i<tabla.getRowCount();i++){
            ...
            proveedores.add(new Proveedor(nombre,CI,direccion,telefono));
        }
        
        try{
            GuardarDatos.writeFileTextProveedor(proveedores);
        }
        catch(Exception ex){
