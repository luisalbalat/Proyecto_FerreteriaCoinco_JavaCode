...
public class Menu_Gerente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtMenuInvitados.setText("MENÚ DE GERENTE");
        ...
        btgUsuario.setText("GESTIONAR USUARIOS");
        ...
        btgProveedores.setText("GESTIONAR PROVEEDORES");
        ...
        btgClientes.setText("INFORMACIÓN DE LOS CLIENTES");
    ...
    private void btgUsuarioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btgUsuarioActionPerformed
        Gestion_Usuarios ventana = new Gestion_Usuarios();
        ventana.setVisible(true);
        ventana.setLocationRelativeTo(null);
    ...
    private void btgProveedoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btgProveedoresActionPerformed
        Gestion_Proveedores ventana = new Gestion_Proveedores();
        ventana.setVisible(true);
        ventana.setLocationRelativeTo(null);
